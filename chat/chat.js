...
var xmlHttponline = createXmlHttpRequestObject();
...
function getColor(e)
{
  ...
  if(xmlHttpGetColor)
  {
    ...
    {
      offsetX -= oPalette.offsetLeft + oTd.offsetLeft+140;
      offsetY -= oPalette.offsetTop + oTd.offsetTop + 140;
